...
class TournamentTypePolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, TournamentType $tournamentType)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, TournamentType $tournamentType)
    {
        return $user->is_admin;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, TournamentType $tournamentType)
    {
        return $user->is_admin;
    }
}
